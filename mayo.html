...
<head>
  ...
  <style>
    header{
      background: url(file:///Users/sameer.somani/Desktop/ite/man.jpg);
...
<body>
  ...
  <section class="container section scrollspy" id="photos">
    <div class="row">
      <div class="col s12 l4">
        <img src="taco.jpg" alt="" class="responsive-img materialboxed">
      </div>
      <div class="col s12 l6 offset-l1">
        <h2 class="indigo-text text-darken-4">Taco</h2>
        <p>Lorem Ipsum kbfjksbkf sosfbvjksbdfsk vksvb ksn fviwbskc vsbvisjbvisbwviusv sjv sidh  kjhsfb shjdbf hjsd</p>
      </div>
    </div>
    <div class="row">
      <div class="col s12 l4 push-l6">
        <img src="mayonnaise.jpg" alt="" class="responsive-img materialboxed">
      </div>
      <div class="col s12 l6 pull-l5 right-align">
        <h2 class="indigo-text text-darken-4 right-align">Mayonnaise</h2>
        <p>Lorem Ipsum kbfjksbkf sosfbvjksbdfsk vksvb ksn fviwbskc vsbvisjbvisbwviusv sjv sidh  kjhsfb shjdbf hjsd</p>
      </div>
    </div>
    <div class="row">
      <div class="col s12 l4">
        <img src="tomato.jpg" alt="" class="responsive-img materialboxed">
      </div>
      <div class="col s12 l6 offset-l1">
        <h2 class="indigo-text text-darken-4">Tomato</h2>
        <p>Lorem Ipsum kbfjksbkf sosfbvjksbdfsk vksvb ksn fviwbskc vsbvisjbvisbwviusv sjv sidh  kjhsfb shjdbf hjsd</p>
      </div>
    </div>
  </section>
  ...
  <div class="parallax-container">
    <div class="parallax">
      <img src="street.jpg" alt="" class="responsive-img">
    </div>
  </div>
  ...
  <div class="parallax-container">
    <div class="parallax">
      <img src="stars.jpg" alt="" class="responsive-img">
    </div>
  </div>
